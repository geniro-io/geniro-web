...
| ------------------------- | ------------------------------ | ------------------------------------- | --------------------------------- |
| **model**                 | **string**                     | Provider model ID, e.g. openai/gpt-4o | [default to undefined]            |
...
```typescript
import { CreateLiteLlmModelDtoLitellmParams } from './api';

const instance: CreateLiteLlmModelDtoLitellmParams = {
  model,
  apiKey,
  apiBase,
  customLlmProvider,
